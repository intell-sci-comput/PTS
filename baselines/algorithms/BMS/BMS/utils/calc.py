...
# operators = ['Add','Mul','FakeSub','FakeDiv','Identity','Neg','Inv','Sin','Cos','Exp','Log'] # fakenormal
operators = ['Add','Mul','Sub','Div','Identity','Sin','Cos','Exp','Log']   # normal

# operators = ['Sub','Div','Sub','Div','Identity','Neg','Inv','Sin','Cos','Exp','Log'] # all_subdiv_normal
