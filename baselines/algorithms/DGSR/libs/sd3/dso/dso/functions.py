...
unprotected_ops = [
    ...
    Token(np.sign, "sign", arity=1, complexity=4),
...
def protected_sign(x1):
    return np.sign(x1)

def protected_abs(x1):
    return np.abs(x1)
...
protected_ops = [
    ...
    Token(protected_sign, "sign", arity=1, complexity=4),
    Token(protected_abs, "abs", arity=1, complexity=4),
