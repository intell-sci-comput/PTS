...
task_file_map = {
    "EMPS": "../../../data/emps/emps.csv",
    "Roughpipe": "../../../data/roughpipe/nikuradze.csv"
}
...
def main(exp_seed, benchmark_name):
    ...
    for benchmark_name in ls:
        ...
        def main(dataset, n_cores_task=conf.exp.n_cores_task):
            ...
            seed = exp_seed
            dataset = task_file_map[task_name]
            task_inputs = seed, dataset, pre_trained_model, baseline
            print('='*40)
            print(task_inputs)
            print('='*40)
        ...
        if __name__ == "__main__":
            ...
            dsoconfig = dsoconfig_factory(function_set=task_function_set_map[task_name])
